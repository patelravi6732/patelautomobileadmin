...
export default function CounterSalePage() {
  ...
  // Handle Add Item to Cart (Option 2: Manual Confirm Mode)
  ...
  // Update Cart Item Quantity (Restores Stock for Confirmed Items when Decremented below confirmed count)
