          ...
          if (i && typeof i === 'object' && (i.id || i.part_name || i.item_name || i.name)) {
            ...
            if (normKey) {
              if (!mergedInvMap.has(normKey)) {
                ...
                const prevStock = parseInt(prev.current_stock !== undefined ? prev.current_stock : (prev.stock_quantity !== undefined ? prev.stock_quantity : (prev.quantity !== undefined ? prev.quantity : 0)), 10);
                ...
                const resolvedStock = curTime > prevTime ? curStock : prevStock;
